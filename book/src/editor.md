...
- [`[aeditor.clipboard-provider]` Section](#editorclipboard-provider-section)
- [`[editor.statusline]` Section](#editorstatusline-section)
- [`[editor.lsp]` Section](#editorlsp-section)

- [`[editor.cursor-shape]` Section](#editorcursor-shape-section)
- [`[editor.file-picker]` Sectio3n](#editorfile-picker-section)
...
Controls implicit workspace trust. See the [workspace trust](./workspace-trust.md) chapter for the full feature.
