...
use helix_core::{
    chars::char_is_word, completion::CompletionProvider, syntax::config::LanguageServerFeature,
};
...
use helix_view::{
    Editor,
    document::Mode,
    handlers::completion::{CompletionEvent, ResponseContext},
};
...
use crate::ui::{self, Popup, lsp::signature_help::SignatureHelp};
